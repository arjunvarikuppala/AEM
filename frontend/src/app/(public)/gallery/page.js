...
import { X, ZoomIn, ChevronLeft, ChevronRight, MapPin, Tag } from "lucide-react";

export default function GalleryPage() {
  const [activeCategory, setActiveCategory] = useState("All");
  const [selectedIndex, setSelectedIndex] = useState(null);

  const categories = ["All", "Excavation & Grading", "Tipper Fleet", "Drainage & Utilities"];
  ...
  const images = [
    ...
    },
    {
      ...
      location: "Infrastructure Haulage Site",
    ...
    },
    {
      ...
      location: "Sub-surface Drainage Network Project",
    ...
    },
    {
      ...
      category: "Drainage & Utilities",
      location: "Roadway Utility Conduit Work",
    ...
    },
    {
      id: 5,
      src: "/images/sany-excavator-grading.jpg",
      title: "Earthmoving & Site Operations Banner",
      category: "Excavation & Grading",
      location: "Outer Ring Road Extension",
      description: "Site clearance and foundation trenching work using versatile heavy machinery.",
      aspect: "aspect-[4/3]"
    },
    {
      id: 6,
      src: "/images/sany-excavator-grading.jpg",
      title: "Heavy Rock Breaker & Excavator Operation",
      category: "Excavation & Grading",
      location: "Patancheru Quarry Site",
      description: "Hydraulic breaker fracturing hard granite strata for road bed formation.",
      aspect: "aspect-[16/9]"
    },
    {
      id: 7,
      src: "/images/tipper-fleet-dumping.jpg",
      title: "Bulldozer & Tipper Roadway Grading",
      category: "Tipper Fleet",
      location: "Industrial Corridor Development",
      description: "Dozer blade leveling and earth shaping across a 50-acre industrial site.",
      aspect: "aspect-[4/3]"
    },
    {
      id: 8,
      src: "/images/trench-pipeline-laying.jpg",
      title: "Sub-grade Drainage Conduit Laying",
      category: "Drainage & Utilities",
      location: "Highway Expansion Sector",
      description: "Soil compaction and sub-grade density optimization for heavy traffic bearing roads.",
      aspect: "aspect-[3/4]"
    }
  ];
  ...
  return (
    <div className="pt-32 pb-20 min-h-screen">
      <section className="container mx-auto px-6 mb-16 text-center">
        ...
        >
          Authentic photography from our active sites — showcasing earthmoving, pipeline installation, and heavy fleet operations.
        </motion.p>
          ...
          {filteredImages.map((img, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6 flex flex-col justify-end">
                ...
                <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-[#F4B400] text-black flex items-center justify-center transform scale-75 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all">
                  <ZoomIn size={20} />
                </div>
              </div>
            </motion.div>
